...
import "./systemAdminFooter.css";
import FNfootericon from "../../../../assets/images/ManagementFooter_img/footerpic.png";
    ...
    return (
        <div className="FNFooterDiv">
            <footer className="FNExactFooter">
                ...
                <div className="FNFooterHeading" style={{ paddingLeft: "30px", paddingBottom: "5px" }}>
                    <p onClick={HomepagesHandle}>UniversalExplorer</p>
                </div>
